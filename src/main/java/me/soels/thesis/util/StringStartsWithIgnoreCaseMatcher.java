...
/**
 * Custom {@link Matcher} for whether a string starts with a string ignoring any casing and allowing for matching
 ...
 */
public class StringStartsWithIgnoreCaseMatcher extends StringContains {
    private final boolean matchingStringWasNull;

    private StringStartsWithIgnoreCaseMatcher(String substring, boolean matchingStringWasNull) {
    ...
    public static Matcher<String> containsStringIgnoringCase(String substring) {
        ...
        return new StringStartsWithIgnoreCaseMatcher(value, substring == null);
    }
