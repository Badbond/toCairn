...
/**
 * Modularity metric as devised by Clauset-Newman-Moore (2004) based on static coupling between classes as
 ...
 */
public class LohnertzStaticCoupling implements Metric {
    @Override
