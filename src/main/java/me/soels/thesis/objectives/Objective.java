...
public interface Objective {
     ...
     * @param analysisInput the input for the analysis containing the information required for this objective
     *                      function to evaluate
     * @return the resulting measurement for this objective function
     */
    double calculate(Clustering clustering, AnalysisInput analysisInput);
}
