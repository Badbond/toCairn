...
/**
 * Modularity metric as devised by Clauset-Newman-Moore (2004) based on semantic coupling between classes as
 ...
 */
public class LohnertzSemanticCoupling implements Metric {
    @Override
